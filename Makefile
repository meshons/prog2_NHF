debug:
	...
	clang++ test_main.cpp memtrace.o string.o -o test2.exe -g -DMEMTRACE -Weverything -Wno-disabled-macro-expansion -pedantic -std=c++11 -Wno-c++98-compat-pedantic  -Wno-old-style-cast -Wno-weak-vtables -Wno-padded 